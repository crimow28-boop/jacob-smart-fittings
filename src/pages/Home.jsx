...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO 
        title="דף הבית" 
        description="יעקב פרזול חכם (גייקוב פרזול) - המרכז המוביל לפתרונות פרזול מתקדמים לנגרים ולבית. קטלוג עשיר של מוצרי פרזול, ידיות, מסילות, צירים ועוד. משלוחים לכל הארץ."
        keywords="יעקב פרזול חכם, גייקוב פרזול חכם, פרזול, נגרות, ידיות, מסילות, צירים, פרזול לנגרים, Jacob Smart Fittings"
      />
